...
>
  <p class="eyebrow">Checkpoint 02</p>
  <h2>About Me</h2>
  <p class="copy">Computer science student focused on full-stack systems, cloud-native delivery, and polished interaction design.</p>
</section>
...
<style>
  .about-overlay {
    ...
    width: min(31rem, calc(100vw - 2.2rem));
